...
export function ParticleHero({ children }: { children?: ReactNode }) {
  ...
  return (
    <div
      className={`relative w-full overflow-hidden ${isGoldMode ? "gold-mode" : ""}`}
      style={{ 
        background: "#1a0b2e",
        backgroundImage: "radial-gradient(circle at 50% 50%, #2d124d 0%, #1a0b2e 100%)",
          ...
          {[0, 1, 2].map((i) => (
            <div
              ...
              style={{
                ...
                backgroundImage:
                  "conic-gradient(from 0deg at 50% -5%, transparent 45%, rgba(168, 85, 247, .3) 49%, rgba(168, 85, 247, .6) 50%, rgba(168, 85, 247, .3) 51%, transparent 55%)",
