      ...
      <header id="home" className="relative">
        <BackgroundGradientGlow className="min-h-screen">
          ...
          <DotGlobeHero className="pt-16 md:pt-20">
            <div className="flex flex-col items-center max-w-5xl px-4 sm:px-6 md:px-[37px] mt-52 md:mt-0">
          ...
          <div className="container-custom">
            <FadeInView className="premium-card rounded-3xl md:rounded-[32px] p-6 md:p-8 lg:py-[24px] lg:px-[60px] overflow-hidden">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center relative z-10">
                ...
                <ScaleInView className="w-full h-[300px] sm:h-[400px] md:h-[600px] flex items-center justify-center relative overflow-hidden">
                  <div className="w-full h-full max-w-[300px] sm:max-w-[400px] md:max-w-none mx-auto">
                    <Suspense fallback={<div className="w-full h-full" />}>
                      <InteractiveGlobe size={500} markers={globeMarkers} connections={globeConnections} dotColor="rgba(124, 58, 237, ALPHA)" arcColor="rgba(124, 58, 237, 0.3)" markerColor="rgba(58, 15, 99, 1)" />
                    </Suspense>
                  </div>
                </ScaleInView>
              </div>
