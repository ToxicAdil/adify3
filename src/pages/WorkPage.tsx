...
const WorkPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#fdfaff] selection:bg-primary selection:text-white relative overflow-hidden">
        ...
        <div className="container-custom px-[37px]">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-slate-500 font-medium leading-relaxed max-w-3xl mx-auto"
            >
          ...
          <div className="flex flex-col md:flex-row justify-around gap-8 md:gap-4 items-center">
            {[
              ...
              >
                ...
                <span className="text-slate-800 font-bold text-lg md:text-xl tracking-tight">{stat.label}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 relative z-10 bg-white/30 backdrop-blur-sm border-y border-slate-100">
        <div className="container-custom px-[37px]">
          <div className="text-center space-y-4 mb-20">
            <h2 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight">What We Can <span className="text-gradient">Build For You</span></h2>
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="group relative bg-white/70 backdrop-blur-md rounded-[32px] p-5 border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:border-primary/20"
              >
                <div className="relative aspect-[16/10] rounded-[24px] overflow-hidden mb-8 shadow-inner">
                  <img 
                    src={industry.img} 
                    alt={industry.title}
                ...
                <div className="px-2 pb-2 space-y-4">
                  <h3 className="text-2xl font-bold text-slate-900 tracking-tight group-hover:text-primary transition-colors">{industry.title}</h3>
      ...
      <section className="py-24 relative z-10">
        <div className="container-custom px-[37px]">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="premium-card rounded-[40px] p-12 md:p-20 text-center space-y-8 bg-white/60 relative overflow-hidden"
          >
            <div className="relative z-10 space-y-4">
              <h2 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight">Want results like this?</h2>
              <p className="text-xl text-slate-500 font-medium max-w-2xl mx-auto">
              ...
              <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-6">
                <MagneticButton>
                  <button className="bg-slate-900 text-white px-10 py-5 rounded-full font-bold text-lg btn-premium flex items-center justify-center gap-3 primary-button">
                    Book a Strategy Call <ArrowRight className="w-6 h-6" />
                  </button>
                </MagneticButton>
                
                <MagneticButton>
                  <button className="px-10 py-5 rounded-full font-bold text-lg text-slate-600 border border-slate-200 hover:bg-white transition-all flex items-center justify-center gap-2 group">
                    Free Audit
                  </button>
                </MagneticButton>
              </div>
        ...
        <div className="bg-white rounded-[32px] overflow-hidden shadow-sm border border-slate-100 h-full flex flex-col transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-purple-900/10 group-hover:border-primary/20">
          ...
          <div className="p-8 flex flex-col flex-1 space-y-6">
            <div className="space-y-4 flex-1">
              ...
              <h3 className="text-3xl font-bold text-slate-900 tracking-tight group-hover:text-primary transition-colors">
                {study.client}
              </h3>
